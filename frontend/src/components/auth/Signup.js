                ...
                <div className="auth-card">
                    {step === 1 ? (
                        <>
                            ...
                            <form onSubmit={handleSubmit} className="auth-form" noValidate>
                                <div className="form-group">
                                    ...
                                    {formErrors.name === 'empty' && <div className="validation-error">{t("auth.pleaseEnterYourName")}</div>}
                                </div>
                                ...
                                <button type="submit" className="btn-auth-submit" disabled={isLoading}>
                                    {isLoading ? t("auth.signingUp") : t("auth.signup.title")}
                                </button>
                            </form>
                        ...
                        <>
                            ...
                            <p className="auth-subtitle">{t("auth.enterThe6DigitCodeSe")} <strong>{formData.email}</strong></p>
